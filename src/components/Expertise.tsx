    ...
    <div className="md:border  md:rounded-3xl p-4">
      <span className="flex flex-col items-center text-center md:items-start md:text-start">
        ...
        <p className="flex md:justify-start justify-center m-4 font-light text-sm md:text-sm text-[#4C585B] w-[80%] uppercase tracking-tight">
          ...
          soluta nihil. Lorem ipsum dolor sit amet consectetur adipisicing elit.
          Beatae odio enim aliquid, voluptatibus soluta nihil.
        </p>
      </span>

      <Tabs className="hidden md:flex md:flex-col p-8 space-y-0" defaultValue="AI Solutions">
        <>
                ...
                <div className="flex flex-col justify-center gap-6">
                  <h1 className=" text-4xl font-bold">
                    <span className="text-[#7E99A3] ">
                      {serviceIconsLarge[service.title as keyof typeof serviceIcons]}
                    </span>
